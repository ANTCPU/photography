  ...
  return (
    <div style={s.root}>
      ...
      >
        ...
        {/* Icon */}
        <div style={{ ...s.dropIcon, color: dragOver ? '#c8f564' : '#4a4f63' }}>
          {dragOver ? '⬇' : '⬆'}
        </div>
      ...
      <div style={s.queue}>
        <div style={s.queueHeader}>
          ...
          <div style={s.queueStats}>
            {totalCount > 0 && (
              <>
                <span style={{ color: 'var(--db-teal)', fontSize: 11 }}>
                  ✓ {doneCount}
                </span>
                {errorCount > 0 && (
                  <span style={{ color: 'var(--db-red)', fontSize: 11 }}>
                    ✕ {errorCount}
                  </span>
                )}
                <span style={{ color: 'var(--db-text-dim)', fontSize: 11 }}>
                  / {totalCount}
                </span>
              </>
            )}
  ...
  return (
    <div style={s.uploadRow}>
      <div style={s.uploadLeft}>
        <span style={{ ...s.uploadDot, background: color }} />
