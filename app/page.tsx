// app/page.tsx
// Amanda Photography Platform — Landing Page
"use client"
      ...
      <main style={s.section}>
        <div style={s.navGrid}>
          ...
          <NavCard
            ...
            icon="✦"
            title="AI Studio"
            desc="Enhance images with context, auto-tagging, and descriptions. Coming in v0.2."
          />
          <NavCard
            href="/wiki"
            icon="◈"
...
const s: Record<string, any> = {
  ...
  topNavLogin: {
    color: "#c8f564", textDecoration: "none", fontSize: 12,
    fontFamily: "'IBM Plex Mono', monospace",
  ...
  heroOverlay: {
    ...
    background: "linear-gradient(to right, rgba(11,13,17,0.88) 40%, rgba(11,13,17,0.15) 100%)",
  ...
  statusBar: {
    borderBottom: "1px solid rgba(255,255,255,0.06)",
    background: "#12151c", padding: "0 20px",
  },
  statusInner: {
