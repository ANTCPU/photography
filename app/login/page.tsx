...
export default function LoginPage() {
  ...
  // On mount — if cookie already valid, skip login entirely
  useEffect(() => {
  ...
  // Checking session — blank screen to avoid flash
  if (status === 'checking') {
    return (
...
const s: Record<string, React.CSSProperties> = {
  ...
  badge: {
    ...
    letterSpacing: '0.15em', color: '#c8f564',
    background: 'rgba(200,245,100,0.08)',
    border: '1px solid rgba(200,245,100,0.2)',
    borderRadius: 20, padding: '3px 10px',
    alignSelf: 'flex-start',
  },
  title: { fontSize: 'clamp(18px, 5vw, 22px)' as any, fontWeight: 700, color: '#e8eaf0', margin: 0 },
  ...
  userBtn: {
    ...
    gap: 8, padding: 'clamp(12px, 3vw, 16px) 12px',
  ...
  avatar: {
    width: 'clamp(44px, 12vw, 56px)' as any,
    height: 'clamp(44px, 12vw, 56px)' as any,
    borderRadius: '50%',
    objectFit: 'cover',
  ...
  fieldLabel: {
    fontSize: 10, fontFamily: "'IBM Plex Mono', monospace",
    letterSpacing: '0.12em', color: '#7c8096',
  ...
  submitBtn: {
    background: '#c8f564', color: '#0b0d11',
