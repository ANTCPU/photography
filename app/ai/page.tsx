...
const TOOLS = [
  ...
  },
  {
    ...
    icon: '◎',
    title: 'Social Pack',
    desc: 'One Cloudinary ID in → full social media pack out. Every platform size as a ready-to-use URL — Instagram, X, LinkedIn, TikTok, YouTube, Pinterest, OG.',
    href: '/studio',
    eta: null,
    tech: 'Cloudinary CDN · GET /api/social-pack',
    writes: null,
    progress: 100,
  },
  {
    ...
    href: null,
    eta: 'v0.3',
    tech: 'Cloudinary · e_background_removal',
  ...
  },
  {
    ...
    icon: '✦',
    title: 'Auto Enhance',
    desc: 'Auto-correct exposure, color, and sharpness on every upload. Cloudinary transformations applied server-side — no manual editing required.',
    href: null,
    eta: 'v0.3',
    tech: 'Cloudinary · e_improve,e_auto_color',
    writes: ['enhancedUrl', 'enhancedThumb'],
    progress: 40,
  },
  {
    id: 'rerender',
    ...
    icon: '◈',
    title: 'AI Rerender',
    desc: 'Style transfer and creative rerender. Transform RAW shots into polished outputs — artistic filters, upscaling, and generative enhancement.',
    href: null,
    eta: 'v0.4',
    tech: 'Cloudinary · e_art,e_style_transfer',
    writes: ['rerenderUrl', 'style', 'model'],
    progress: 15,
  },
  {
    id: 'describe',
